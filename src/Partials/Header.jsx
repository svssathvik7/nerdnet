  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center relative">
        ...
        {expand && (
          <div className="the-menu-head absolute top-0 bg-white p-2 rounded-md shadow-md right-0 w-44 flex flex-col items-center justify-start">
            <button
              onClick={() => {
                setExpand(false);
              }}
            ...
            <button className="block relative text-gray-800 hover:bg-gray-200 py-1 px-2 rounded-md">
              Notifications
              {user && user.notifications && user.notifications.length > 0 && (
                <p className="bg-red-600 absolute top-0 -right-2 w-4 h-4 text-white rounded-full text-center flex items-center justify-center text-xs">
                  {user.notifications.length > 9 ? "9+" : user.notifications.length}
                </p>
              )}
            </button>
            <a
